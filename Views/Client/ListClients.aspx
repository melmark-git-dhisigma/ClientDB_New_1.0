                                    ...
                                    <tr>
                                        ...
                                        <%--<td class="nobdr" style="padding: 0; text-align: left; width: 10%">--%>
                                         ...
                                         <td style="width:15%;">
                                            ...
                                            <input type="radio" name="activeClient1" value="2" onchange="sortClients()"  />Discharge
                                              <input type="radio" name="activeClient1" value="3" onchange="sortClients()"/>Both
                                            
                                            <%}
                                              else if (ViewBag.activeClientstatus == 2)
                                              {%>
                                            <input type="radio" name="activeClient1" value="1" onchange="sortClients()"  />Active
                                            <input type="radio" name="activeClient1" value="2" onchange="sortClients()" checked="checked" />Discharge
                                              <input type="radio" name="activeClient1" value="3" onchange="sortClients()"/>Both
                                             ...
                                             <input type="radio" name="activeClient1" value="1" onchange="sortClients()"/>Active
                                            <input type="radio" name="activeClient1" value="2" onchange="sortClients()" />Discharge
                                              <input type="radio" name="activeClient1" value="3" onchange="sortClients()"  checked="checked"/>Both
                                                <%} %>       
                                             </td>
                                        <td style="width:10%;">
