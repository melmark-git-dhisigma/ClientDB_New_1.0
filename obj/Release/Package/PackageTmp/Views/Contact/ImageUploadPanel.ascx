...
<table class="tblStyle">
    ...
    <tr>
                        ...
                        <%if (Session["PlacementStat"].ToString() != "I")
                          {
                              if (ViewBag.imageUrl != null && ViewBag.Photodate != null)
                              {%>

                        <tr style="border-bottom: 1px solid #DDDDDD;border-right: 1px solid #DDDDDD;color: #525252;font-family: Arial,Helvetica,sans-serif;font-size: 11px !important;font-weight: bold;padding: 8px 1px;">
                            <td><label class="lblSpan" style="margin-right:10px">Photo Date Taken: </label>
                            <%=ViewBag.Photodate %>
                            </td>
