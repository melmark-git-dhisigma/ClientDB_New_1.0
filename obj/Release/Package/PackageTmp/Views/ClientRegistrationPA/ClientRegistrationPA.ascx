...
<div style="width: 100%;">
    ...
    <div>
        ...
        <table>
            ...
            <tr>
                  <td style="width: 0">
                    <label class="lblSpan">Height(ft)</label><span class="nospan-align">*</span><br />
                    <%=Html.TextBoxFor(m => m.Height, Model.Height, new {  @class="numbersOnly",onpaste="funPaste(event);",ID="txtHeight" })%></td>
                <td  style="width: 0">
                    <label class="lblSpan">Weight(lbs)</label><span class="nospan-align">*</span><br />
                    <%=Html.TextBoxFor(m => m.Weight, Model.Weight, new {  @class="numbersOnly",onpaste="funPaste(event);", ID="txtWeight" })%></td>
