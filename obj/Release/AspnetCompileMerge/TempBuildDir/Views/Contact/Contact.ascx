...
<div id="partialMainArea">
    <table class="tblStyle" style="width: 70% !important;">
        ...
        <tr>
            <td colspan="1">
                <label class="lblSpan">Emergency Contact</label><span class="nospan-align">*</span><br />
                <%=Html.CheckBoxFor(x=>x.IsEmergency)%>
            ...
            <div id="ContactSection">
                ...
                <div id="contactHome">
                    ...
                    <table style="border: 1px solid #F0F0F0; background: none repeat scroll 0 0 #F0F0F0;" width="100%" cellpadding="0" cellspacing="0" style="background: #F0F0F0">
                        ...
                        <tr>
                            <td colspan="2">
                                <label class="lblSpan">Floor/Suite#</label><span class="greyspan-align">*</span><br />
