...
public class clsData
{
    ...
    private static SqlConnection mCon =  new SqlConnection(ConfigurationManager.ConnectionStrings["dbConnectionString2"].ToString());
    ...
    public void ExecutePhoto(byte[] content, int Id, bool val)
    {
        using (cmd = new SqlCommand())
        {
            ...
            catch (SqlException ex)
            {
                ...
                errlog.WriteToLog("Page Name: " + Other_Functions.getPageName() + "\t" + ex.ToString());
            }
        }
    }
    ...
    public string ConnectionString
    {
        get
        {
            return mConectionString = ConfigurationManager.ConnectionStrings["dbConnectionString2"].ToString();
        }
    }
    ...
    public object FetchValue(string SQL)
    {
        ...
        {
            errorLog errlog = new errorLog();
            errlog.WriteToLog("Page Name: " + Other_Functions.getPageName() + "\t" + exp.ToString());
        }
        ...
        try
        {
            ...
            if (GetSchema)
            {
                ...
                catch (Exception e)
                {
                    ...
                    {
                        errorLog errlog = new errorLog();
                        errlog.WriteToLog("Page Name: " + Other_Functions.getPageName() + "\t" + e.ToString());
                    }
                    Dt = null;
